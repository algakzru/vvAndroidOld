...
//        closeButton = findViewById(R.id.close_button);
    ...
    public static final class VideoListFragment extends ListFragment {
        ...
        private static final List<VideoEntry> VIDEO_LIST = new ArrayList<VideoEntry>();
//        static {
...
//        }
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            Cursor cur = db.query("word_video inner join video on word_video.video_id = video.video_id inner join word on word_video.word_id = word.old_id", null, selection, null, "word_video.word_id", null, "random()");
            if (cur.getCount() > 0) {
                while (cur.moveToNext()) {
                    VIDEO_LIST.add(new VideoEntry(cur.getString(cur.getColumnIndex("word")), cur.getString(cur.getColumnIndex("old_id")),cur.getString(cur.getColumnIndex("youtube_id"))));
                    //L.d("", "topid = %s", cur.getString(cur.getColumnIndex("topic")));
                }
            }
            cardDatabase.close();
...
//    }
    ...
    private static final class VideoEntry {
        ...
        public VideoEntry(String text, String wordId,String videoId) {
            this.text = text;
            this.wordId = wordId;
            this.videoId = videoId;
        }
