...
public class Config
{
    ...
    Config()
    {
        ...
        data.put("database", "default-");
        data.put("start_days", "0");
        data.put("start_date", "1970-01-01");
        data.put("last_day", String.valueOf(nowInDays()+7));
    }
    ...
    public long nowInDays()
    {
        ...
        return (hours + tzoff - dayStartsAt()) / 24;
    }
